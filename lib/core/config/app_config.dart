class AppConfig {
  static const String supabaseUrl = 'https://amdxufleuibrpbufmagu.supabase.co';
  static const String supabaseAnonKey = 'sb_publishable_mlkQG8rhKr70FeJJtrFiUw_ClleN6Ma';
